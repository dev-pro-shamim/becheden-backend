...
export default {
  ...
  ssl: {
    ...
    subscription_payment_validation_url:
      process.env.SUBSCRIPTION_PAYMENT_VALIDATION_URL,
    lottery_payment_validation_url: process.env.LOTTERY_PAYMENT_VALIDATION_URL,
