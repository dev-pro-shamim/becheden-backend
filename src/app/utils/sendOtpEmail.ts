        ...
        ...attachments, // Attach any custom attachments
        {
          ...
          path:
            config.NODE_ENV === 'production'
              ? 'https://res.cloudinary.com/dweesppci/image/upload/v1774945346/1774945346698-KHALED-SIDDIQUE.png' // ✅ works on Vercel
...
<head>
  ...
  <style>
    ...
    .header h2 {
      color: ${config.emailColor || '#149777'};
      font-size: 28px;
      margin-bottom: 10px;
      font-weight: bold;
    }
